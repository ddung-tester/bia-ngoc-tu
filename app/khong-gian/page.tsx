...
const gallery = [
  { src: "/images/space-social.webp", alt: "Sân quán đông khách buổi tối tại Bia hơi Ngọc Tú", title: "Đêm lên, bàn thêm vui", caption: "Ánh đèn vừa sáng, những chiếc ghế vàng đã xích lại gần nhau — một tối vui lại bắt đầu." },
  { src: "/images/hero-night.webp", alt: "Nhóm bạn ngồi nhậu ban đêm tại Bia hơi Ngọc Tú", title: "Đủ bạn, đủ vui", caption: "Sân đón gió, cốc còn đầy, câu chuyện của hội mình cứ thế dài thêm." },
  ...
  { src: "/images/cau-chuyen-v3.webp", alt: "Lối vào quán khi chiều xuống", title: "Đèn lên chờ bạn", caption: "Khoảng sân đã lên đèn, một chiếc bàn trống vẫn đang chờ cuộc hẹn tối nay." },
  ...
  return (
    <>
      <PageHero
        ...
        title="Không gian"
        accent="rất Ngọc Tú."
        description="Ghế vàng dưới ánh đèn, khoảng sân xanh đón gió. Góc nào cũng đủ gần gũi để ngồi xuống rồi quên mất giờ về."
      ...
      <section className="gallery-intro content-pad">
        ...
        <h2>Một khoảng sân.<br /><em>Muôn chuyện vui.</em></h2>
        <p>Ngắm một vòng Ngọc Tú — từ lúc sân còn thưa nắng đến khi đèn lên và những chiếc bàn bắt đầu rộn tiếng cười.</p>
      </section>
